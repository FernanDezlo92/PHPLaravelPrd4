@php
    ...
    use App\Http\Controllers\TipoAController;
@endphp
    ...
    <table class="table" style="width: 70%;">
        <thead>
            <tr>
                ...
                <td><a href="{{ url('/views/admin/tipos-actosNuevo.php') }}"><button class="btn btn-success"><i class="fa fa-plus fa-lg"></i>&nbsp;Crear tipo de acto</button></a></td>
            </tr>
        </thead>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('/php/tipos-actosFormAccion.php') }}" method="POST">
                    @csrf
...
<script>
    function editarTipoActo(id) {
        var url = "{{ url('/views/admin/tipos-actosEditar.php?id=') }}" + id;
